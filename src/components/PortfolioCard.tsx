...
const PortfolioCard = ({ projects }: any) => {
  return (
    <div className="grid md:grid-cols-2 gap-6">
      {projects?.slice(0, 6).reverse().map((project: any, index: number) => (
        <motion.div
          key={project.slug}
          ...
          <Link href={`/project/${project.slug}`}>
            ...
            >
              <div className="p-2">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="w-[60px] px-4">
                    <motion.div
                      ...
                      className="w-12 h-12 rounded-full bg-[#E1B505] flex items-center justify-center text-black foreground group-hover:opacity-100 transition-opacity"
                    >
                ...
                <p className="text-muted-foreground text-sm group-hover:opacity-100 transition-opacity duration-300">
