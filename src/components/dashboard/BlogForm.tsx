...
const BlogForm = ({ editSlug, onClose }: BlogFormProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Blog data to send to API:", blogData);

    toast({
      title: editSlug ? "Blog Updated" : "Blog Created",
      description: `"${formData.title}" has been ${editSlug ? "updated" : "created"} successfully. Check console for API payload.`,
    });
      ...
      <Card className="glass-card">
        <CardHeader>
          <div className="flex items-center gap-4">
            ...
            <CardTitle>{editSlug ? "Edit Blog Post" : "Create New Blog Post"}</CardTitle>
          </div>
        </CardHeader>
        <CardContent>
