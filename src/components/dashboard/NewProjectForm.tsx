...
const NewProjectForm = ({ editSlug, categories }: ProjectFormProps) => {
  ...
  useEffect(() => {
    if (editSlug) {
      const project = getProjectBySlug(editSlug) as ProjectType | undefined;
      if (project) {
        setFormData({
          title: project.title,
          slug: project.slug,
      ...
      <Card className="glass-card">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2 bg-black text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-3 pt-6">
                ...
                />
                <Label htmlFor="live">Live Project</Label>
              </div>
            </div>
